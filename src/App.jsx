...
const App = () => {
  ...
  return (
    <div className="max-w-md mx-auto p-4 bg-background">
      ...
      />
      <div className="my-6 bg-secondary text-secondary-foreground rounded-lg p-4">
      ...
      {error && (
        <div className="my-6 bg-destructive text-destructive-foreground rounded-lg p-4">
...
const BibleReferenceCard = React.forwardRef(({ reference, duration, isActive, passage, arabicPassage, onClick }, ref) => {
  ...
  return (
    <div 
      className={`mb-4 bg-card text-card-foreground shadow rounded-lg ${isActive ? 'ring-2 ring-primary ring-opacity-50' : ''} transition-all duration-300 ease-in-out hover:shadow-md`}
      ref={ref}
      onClick={onClick}
    >
      <div className="p-4">
